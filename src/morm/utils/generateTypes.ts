...
export function generateTypes(
  ...
  lines.push(`// ⚠️  Auto-generated by MORM — do not edit manually`);
  lines.push(`// Generated: ${new Date().toISOString()}`);
  lines.push(`// Add this file to .gitignore — never import it directly`);
  lines.push(``);
  lines.push(`export {};`);
  lines.push(``);
  ...
  for (const { table, typeName } of modelTypes) {
    lines.push(`    ${table}: {`);
    lines.push(
      `      create: (clause: import("./morm/query/index.js").CreateClause<${typeName}>) => Promise<${typeName} | ${typeName}[] | { count: number }>;`,
    );
    lines.push(
